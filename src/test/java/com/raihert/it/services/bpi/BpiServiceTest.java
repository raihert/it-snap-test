...
class BpiServiceTest {
    private final BpiService service = new BpiService();
    ...
    void handleSuccess() throws Exception {
        ...
        service.setCoindeskService(coindeskService);
        ...
        service.setExchangeRatesService(exchangeRatesService);

        Result result = service.handle("RUR");
    ...
    public void successPrepared() throws Exception {
        ...
        service.prepared(prices, "RUR", result);
    ...
    public void wrongResponsePrepared() throws Exception {
        ...
        try {
            service.prepared(new HistoricalPrice(), "RUR", result);
